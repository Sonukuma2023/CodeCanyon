...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <form class="form-sample" method="POST" action="{{ route('admin.updateproduct', $product->id) }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row mt-3">
                    <div class="col-md-12 text-end">
                        ...
                        <a href="{{ route('admin.viewproduct') }}" class="btn btn-light btn-rounded btn-fw">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
